...
app.get('/games/:id/ads', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.json(ads.map(ad => {
        return Object.assign(Object.assign({}, ad), { weekDays: ad.weekDays.split(','), hourStart: (0, convert_minutes_string_to_hour_1.convertMinutesToHourString)(ad.hourStart), hourEnd: (0, convert_minutes_string_to_hour_1.convertMinutesToHourString)(ad.hourEnd) });
    }));
}));
