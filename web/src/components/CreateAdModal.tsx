    ...
    return(
        <Dialog.Portal>
          ...
          <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[480px] shadow-black/25'>
            <Dialog.Title className='text3xl font-black'>Publique um anúncio</Dialog.Title>
              ...
              <form onSubmit={handleCreateAd} className='mt-8 flex-col gap-4'>
                ...
                <div className='flex gap-6'>
                  ...
                  <div className='flex flex-col gap-2 flex-1'>
                    <label htmlFor='hourStars'>Qual horário do dia?</label>
                ...
                <footer className='mt-4 flex justify-end gap-4'>
                  ...
                  <button type='submit' className='bg-violet-500 px-5 h-12 rounded-md font-semibold items-center gap-3 hover:bg-violet-600'>
